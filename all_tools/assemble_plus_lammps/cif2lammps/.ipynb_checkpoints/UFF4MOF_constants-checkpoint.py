...
UFF4MOF_atom_parameters = {
    ...
    # Additional Zn types for higher coordination numbers - very conservative parameters
    "Zn6f3": (1.600, 90.0, 2.900, 0.060, 12.0, 1.0000, 0.000, 5.106),
    "Zn8f4": (1.700, 109.4712, 3.000, 0.040, 12.0, 0.9000, 0.000, 5.106),
    "Zn6+2": (1.550, 90.0, 2.850, 0.070, 12.0, 1.1000, 0.000, 5.106),
    "Zn6+3": (1.500, 90.0, 2.800, 0.080, 12.0, 1.1500, 0.000, 5.106),
